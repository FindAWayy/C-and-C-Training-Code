// Exception Handling( example 5 ) Nested Try Catch
...
void level4Function(int a, int b) {
    try {
        ...
        // Rethrow the exception to the outer level (level 3)
        throw;  // Rethrow to outer level (level 3)
    }
}
...
void level3Function(int a, int b) {
    try {
        long long result = static_cast<long long>(a) * b;  // Using long long to detect overflow
        ...
        level4Function(a, b);  // Call level 4 function to perform division
    } catch (const overflow_error& e) {
        cout << "Caught in level3Function (level 3): " << e.what() << endl;
        // Rethrow the exception to the outer level (level 2)
        throw;  // Rethrow to outer level (level 2)
    }
}
...
void level2Function(int a, int b) {
    try {
        ...
        level3Function(a, b);  // Call level 3 function to perform multiplication
    } catch (const underflow_error& e) {
        cout << "Caught in level2Function (level 2): " << e.what() << endl;
        // Rethrow the exception to the outer level (level 1)
        throw;  // Rethrow to outer level (level 1)
    }
}
...
void level1Function(int a, int b) {
    try {
        ...
        // Rethrow the exception to the outermost level (main)
...
int main() {
    try {
        ...
        // Handle invalid_argument (e.g., negative numbers)
    } catch (const underflow_error& e) {
        cout << "Caught in main (outer): " << e.what() << endl;
        // Handle underflow_error (subtraction underflow)
    } catch (const overflow_error& e) {
        cout << "Caught in main (outer): " << e.what() << endl;
        // Handle overflow_error (multiplication overflow)
    } catch (...) {
